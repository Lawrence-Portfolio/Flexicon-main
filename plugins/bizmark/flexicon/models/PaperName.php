 ...
 *
 * Relations
 * @property BoxType                                        $paper_types
 * @method \October\Rain\Database\Relations\HasMany|BoxType paper_types()
 *
 * @property File                                           $image
 * @method \October\Rain\Database\Relations\AttachOne|File  image()
 */
class PaperName extends Model
{
     ...
     */
    public $table = 'bizmark_flexicon_paper_names';
